...
constexpr Score SEMI_OPEN_FILE_BONUS[NPIECE_TYPES] = {
		Score(0, 0), Score(0, 0), Score(0, 0), Score(15, 15), Score(0, 0), Score(0, 0),
};
constexpr Score OPEN_FILE_BONUS[NPIECE_TYPES] = {
		Score(0, 0), Score(0, 0), Score(0, 0), Score(30, 30), Score(0, 0), Score(0, 0),
};
