...
int singular_extension(Position& board, int alpha, int beta, bool excluding_move,
					   int ply, int depth, Move legal_move, TranspositionTableSearchResults tt_probe_results, PVSData& data) {
